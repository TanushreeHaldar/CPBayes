...
#'    not provided by the user, default name is specified as `variant'.} 
...
#'       corresponding value of PPAj.}
#'    \item{auxi_data}{It contains supplementary data generated by the MCMC which is used by the
...
#'            \item sim.beta: MCMC data on unknown true association parameters (beta).
#'        }
#'    }
...
#'    
#' @seealso \code{\link{post_summaries}}, \code{\link{cpbayes_uncor}}
#' 
#' @examples
#' data(ExampleDataCor)
