...
#'      
#' @param mcmc_output A list returned by the main CPBayes functions \code{\link{cpbayes_uncor}}
#'  or \code{\link{cpbayes_cor}}. This list 
#' contains all the primary results and MCMC data produced by \code{\link{cpbayes_uncor}}
#'  or \code{\link{cpbayes_cor}}. No default specified. See the example below.
...
#'          association (PPAj) and the direction of associations.}
