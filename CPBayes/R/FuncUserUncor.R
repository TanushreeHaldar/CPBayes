...
#' 
#' Run uncorrelated version of CPBayes when the main genetic effect estimates (beta hats) across
#'  traits/studies are uncorrelated.
#' @param BetaHat A numeric vector of dimension K where K is the number of phenotypes. It
#'  contains the beta hat values across traits/studies. No default is specified.
...
#'     provided by the user, default name is specified as `variant'.} 
...
#'        their corresponding values of PPAj.}
#'    \item{auxi_data}{It contains supplementary data generated by the MCMC which is used
...
#'            \item sim.beta: MCMC data on the unknown true genetic effects (beta s) on all the traits.
#'        }
#'    }
#'    \item{runtime}{It provides the runtime (in seconds) taken by CPBayes. It will help the user
#'     to plan the whole analysis.}
#' 
#' @seealso \code{\link{post_summaries}}, \code{\link{cpbayes_cor}}
#' 
#' @examples
